...
def start():
    ...
    min_transactiondate = (
        input("Please enter START of transaction date (otherwise press enter): ")
        or currenttime()[:4] + "-01-01"
    )
    max_transactiondate = (
        input("Please enter END of transaction date (otherwise press enter): ")
        or currenttime()
    )
